...
model=Sequential()
model.add(Convolution2D(nb_filter=32, nb_row=3, nb_col=3, input_shape=(150,150,3)))
...
train_datagen=ImageDataGenerator(rescale=1.0/255, shear_range=0.2, zoom_range=0.2, horizontal_flip=False)
...
model.fit_generator(train_generator, samples_per_epoch=20893, nb_epoch=20, 
                    validation_data=validation_generator, nb_val_samples=900)
